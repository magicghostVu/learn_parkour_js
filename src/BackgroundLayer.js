var BackgroundLayer = cc.Layer.extend({
    ...
    loadObjects: function (map, mapIndex) {
        ...
        /* Remember that coin array is just like an array of positions
         of the coins, no sprite, no body
         * */
        var coinArray = coinGroup.getObjects();
        for (var i = 0; i < coinArray.length; i++) {

            //create new real Coin based on coin array position
    ...
    checkAndReload: function (eyeX) {
        ...
        if (newMapIndex % 2 == 0) {
            ...
            /* reset position and reload object (coin and rock)
            * */
